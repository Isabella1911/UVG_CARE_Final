...
class ThingsDb {
    private val cosas: List<java.lang.Character> = listOf(
        ...
        fun getAllCharacters(): List<java.lang.Character> {
            return cosas
        }

        fun getCharacterById(id: Int): java.lang.Character {
            return cosas.first { it.id == id }
        }
}
